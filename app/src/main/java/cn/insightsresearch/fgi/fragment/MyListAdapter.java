...
public class MyListAdapter extends BaseAdapter {
    ...
    public MyListAdapter(Context context, ArrayList<Paper> list){
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            view = LayoutInflater.from(context).inflate(R.layout.item_list1, null);
        ...
        viewHolder.content.setText("回答总数："+list.get(i).getTotal());
        viewHolder.id.setText(list.get(i).getPid()+"");
        viewHolder.text.setText("最近回答："+DateUtil.getFormatDateTime(list.get(i).getUdate()));
