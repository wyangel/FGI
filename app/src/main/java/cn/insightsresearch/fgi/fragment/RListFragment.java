...
import cn.insightsresearch.fgi.ResultActivity;
...
public class RListFragment extends android.support.v4.app.ListFragment {
    private String TAG = RListFragment.class.getName();
    ...
    public static RListFragment newInstance(String index) {
        RListFragment f = new RListFragment();
    ...
    private void updateTotalData() {
        for(Paper paper:nlist){
            ...
            ResultManager resultManager = new ResultManager(getActivity(),pid);
...
//                    nlist.addAll(list);
    ...
    private void initView() {
        ...
        adapter= new MyListAdapter(getContext(),nlist);
