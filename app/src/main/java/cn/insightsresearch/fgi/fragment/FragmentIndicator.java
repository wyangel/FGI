...
public class FragmentIndicator extends LinearLayout implements View.OnClickListener{
    ...
    private void init() {
        ...
        mIndicators[2] = createIndicator(R.drawable.ic_setting_normal,
    ...
    public static void setIndicator(int which) {
        ...
        switch(mCurIndicator) {
            ...
            case 2:
                ...
                prevIcon.setImageResource(R.drawable.ic_setting_normal);
        ...
        switch(which) {
            case 0:
                ...
                currIcon.setImageResource(R.drawable.ic_home_focus);
            ...
            case 1:
                ...
                currIcon.setImageResource(R.drawable.ic_search_normal);
            ...
            case 2:
                ...
                currIcon.setImageResource(R.drawable.ic_setting_focus);
